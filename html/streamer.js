...
WebRtcStreamer.prototype.getURL= function(path) {
    var u = this.srvurl + "path";
    if (this.token)
		{
			u += (u.indexOf("?")>0) ? "&":"?";
			u+="token="+this.token;
...
WebRtcStreamer.prototype.connect = function(streamID) {
	...
	// getIceServers is not already received
		...
		send(this.srvurl + "/getIceServers?token="+this.token+"&id="+streamID, null, null, function(iceServers) { this.onReceiveGetIceServers(iceServers, streamID); } , null, this);
